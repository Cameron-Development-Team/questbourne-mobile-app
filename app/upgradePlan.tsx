...
export default function UpgradePlanScreen() {
  ...
  const onConfirm = () => {
    // TODO: call backend to upgrade plan & charge
    console.log('Upgrade plan with promo:', promo);
  };
    ...
    <>
      ...
      <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        <View style={styles.panel}>
          {/* Target (higher) plan summary */}
          <Text style={styles.sectionLabel}>Legend Subscription</Text>

          {/* Token pill */}
          <View style={styles.pill}>
            <Text style={styles.pillText}>212561 / 216000 monthly image tokens</Text>
          </View>
          ...
          <View style={[styles.rowBetween, { paddingVertical: 12 }]}>
            ...
            <Text style={styles.lineTextBold}>$100USD</Text>
          </View>
          <View style={styles.hair} />
          ...
          <View style={{ marginTop: 16 }}>
            ...
            <Text style={styles.chargedAmount}>$100USD</Text>
          </View>
          ...
          <Text style={styles.footnote}>
            ...
            <Text style={{ fontWeight: '700' }}>Automatic annual renewal:</Text> You will automatically be charged each month.
          </Text>
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  pillText: { color: WHITE_SOFT, fontSize: 14 },

  link: { color: GOLD, fontWeight: '700', marginTop: 10 },
  ...
  question: { color: WHITE, fontSize: 14, fontWeight: '700' },
  ...
  footnote: { color: MUTED, fontSize: 12, lineHeight: 18, marginTop: 14 },
});