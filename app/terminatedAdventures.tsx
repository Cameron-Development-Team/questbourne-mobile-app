  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.searchBar}>
        <TextInput placeholder="Search here" placeholderTextColor="#999" style={styles.searchInput} />
      </View>
      ...
      >
        <View style={styles.bannerContent}>
          ...
          <Text style={styles.bannerText}>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</Text>
          </View>
          <View>
      ...
      <View style={styles.beginSection}>
        ...
        <Text style={styles.sectionTitle}>Restore Your Previous Adventure</Text>
      </View>
            ...
            <View style={styles.cardImageWrapper}>
              ...
              >
                <View style={styles.cardHeaderInfo}>
                  <Image source={require('../assets/userPlaceholder.png')} style={styles.userAvatar} />
